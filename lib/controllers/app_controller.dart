...
class AppController extends ChangeNotifier {
  ...
  Future<bool> saveLearnerProfile({
    ...
    try {
      ...
      learnerProfession = cleanProfession;
      learnerEmail = cleanEmail;
      await _prefs.setString(_learnerNameKey, cleanName);
      await _prefs.setString(_learnerProfessionKey, cleanProfession);
      await _prefs.setString(_learnerEmailKey, cleanEmail);
      ...
      try {
        ...
        registrationError =
            'Profil enregistré. L’envoi sera retenté automatiquement.';
      }
      ...
      registrationSubmitting = false;
      registrationError = 'Impossible d’enregistrer le profil.';
      notifyListeners();
      return false;
    }
  }
  ...
  Future<void> _retryPendingRegistration() async {
    ...
    try {
      ...
      // Le profil reste utilisable hors connexion. Un nouvel essai sera fait
