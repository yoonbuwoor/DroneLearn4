...
if index.exists():
    ...
    text = text.replace("<title>droneatlas</title>", "<title>DroneAtlas Academy</title>")
    text = text.replace('content="droneatlas"', 'content="DroneAtlas Academy"')
    text = text.replace(
